...
const ThemedIcons = {
  // Navigation Icons
  HomeIcon: createSVGIcon(homeIconPaths),
  ExploreIcon: createSVGIcon(exploreIconPaths),
  ServicesIcon: createSVGIcon(servicesIconPaths),
  AboutIcon: createSVGIcon(aboutIconPaths),
  
  // Theme Icons
  SunIcon: createSVGIcon(sunIconPaths),
  MoonIcon: createSVGIcon(moonIconPaths),
  
  // Technology Icons
  BrainIcon: createSVGIcon(brainIconPaths, { colorVar: '--ai-color' }),
  BlockchainIcon: createSVGIcon(blockchainIconPaths, { colorVar: '--blockchain-color' }),
  MetaverseIcon: createSVGIcon(metaverseIconPaths, { colorVar: '--metaverse-color' }),
  Web3Icon: createSVGIcon(web3IconPaths, { colorVar: '--web3-color' }),
};
